...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Perform a Mouse Pick on the scene and stores the results with sepcified camera.")]
	public class MousePickWithCamera : FsmStateAction
	{
		...
		void DoMousePick()
		{
			...
			Ray ray = ((Camera) camera.Value).ScreenPointToRay (Input.mousePosition);
			RaycastHit hitInfo;
